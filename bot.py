...
# CoinPaprika uses "xrp-xrp" as the coin id for XRP
...
def get_price():
    ...
    Uses CoinPaprika instead of CoinGecko, since CoinGecko was blocking
    this IP with repeated 429s.
    """
    try:
        r = requests.get(
            "https://api.coinpaprika.com/v1/tickers/" + COINPAPRIKA_ID,
            timeout=10
        )
    ...
    try:
        ...
        change = float(data["quotes"]["USD"].get("percent_change_24h", 0))
